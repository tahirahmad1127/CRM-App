...
class SavedSeeAllScreen extends StatefulWidget {
  const SavedSeeAllScreen({super.key});

  @override
  State<SavedSeeAllScreen> createState() => _SavedSeeAllScreenState();
}

class _SavedSeeAllScreenState extends State<SavedSeeAllScreen> {
