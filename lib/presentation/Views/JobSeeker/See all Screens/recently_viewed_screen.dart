...
class RecentlyViewedSeeAllScreen extends StatefulWidget {
  const RecentlyViewedSeeAllScreen({super.key});

  @override
  State<RecentlyViewedSeeAllScreen> createState() => _RecentlyViewedSeeAllScreenState();
}

class _RecentlyViewedSeeAllScreenState extends State<RecentlyViewedSeeAllScreen> {
