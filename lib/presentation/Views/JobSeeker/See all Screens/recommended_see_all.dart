...
class RecommendedSeeAllScreen extends StatefulWidget {
  const RecommendedSeeAllScreen({super.key});

  @override
  State<RecommendedSeeAllScreen> createState() => _RecommendedSeeAllScreenState();
}

class _RecommendedSeeAllScreenState extends State<RecommendedSeeAllScreen> {
